/**
 * MLB home ballparks — keep in sync with `packages/shared/src/mlbBallparks.ts`.
 * Duplicated here so the API build does not compile the whole shared package under NodeNext.
 */
